  ...
  Future<bool> uploadDocument() async {
    ...
    if (docuName != "") {
      try {
        ...
        print(e);
        showToast("Une Erreur s est produite, Merci de réessayer",
            context: context, backgroundColor: Colors.red);
      }
    } else {
      showToast("Choisir le Document",
          context: context, backgroundColor: Colors.red);
      return false;
    }
    return false;
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      validator: (value) {
                        if (value == null || value.isEmpty) {
                          return 'Please entrer Adhar number';
                        } else if (value.length != 12)
                          return 'Please entrer Valid Adhar number';
                        return null;
                      },
                      //maxLength: 12,
                      style: const TextStyle(
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      validator: (value) {
                        if (value == null || value.isEmpty) {
                          return 'Entrer Pan Number Svp';
                        } else if (value.length != 10)
                          return 'Entrer Valid Adhar number Svp';
                        return null;
                      },
                      style: const TextStyle(
                        fontSize: 15,
                    ...
                    child: TextFormField(
                      validator: (value) {
                        ...
                        if (!regex.hasMatch(value!) || value == null)
                          return 'Entrer a valid email address';
                        else
                          return null;
                      },
                      style: const TextStyle(
                  ...
                  isAdded
                      ? CustomButton('Continue pour s\'identifier', () {
