      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            // ),
            const Text(
                'Entrer la clé privée de votre wallet Ou Connectez votre Metamask wallet'),
            Container(
              width: width,
              child: Padding(
                        ...
                        if (_formKey.currentState!.validate()) {
                          ...
                          try {
                            ...
                            if (widget.val == "owner") {
                              ...
                              if (temp == false) {
                                setState(() {
                                  errorMessage = "Vous n\'etes pas autorisé";
                                });
                              } else {
                              ...
                              if (temp) {
                                setState(() {
                                  errorMessage = "Vous etes déja enregistré";
                                });
                              } else {
                                Navigator.push(
                                    context,
                            ...
                            print(e);
                            showToast("Quelque chose s\'est mal passée",
            ...
            const Text('Ou Click sur connect Metamask'),
            ElevatedButton(
              onPressed: () async {
