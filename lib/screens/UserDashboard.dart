...
class _UserDashBoardState extends State<UserDashBoard> {
  ...
  List<dynamic> prices = [];
  List<Menu> menuItems = [
    Menu(title: 'Tableau de bord', icon: Icons.dashboard),
    Menu(title: 'Enregistrer', icon: Icons.add_chart),
    Menu(title: 'Mes Proprietés', icon: Icons.landscape_rounded),
    Menu(title: 'Gallerie', icon: Icons.landscape_rounded),
    Menu(title: 'Demandes recues', icon: Icons.request_page_outlined),
    Menu(title: 'Demandes d envoi', icon: Icons.request_page_outlined),
    Menu(title: 'Deconnexion', icon: Icons.logout),
  ];
  ...
  Future<bool> uploadDocument() async {
    ...
    if (isFilePicked) {
      try {
        ...
        print(e);
        showToast("Une erreur s est produite, lors du chargement",
            context: context, backgroundColor: Colors.red);
      }
    } else {
      showToast("Choisir Document",
          context: context, backgroundColor: Colors.red);
      return false;
    }
    return false;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Tableau de bord User'),
      ),
      drawer: drawer2(),
            ...
            children: [
              ...
              Row(
                children: const [
                  ...
                  Expanded(
                      child: Center(
                        child: Text('Proprietaire Address',
                            style: TextStyle(fontWeight: FontWeight.bold)),
                      ),
                      flex: 5),
                  Expanded(
        ...
        child: GridView.builder(
          ...
          itemBuilder: (context, index) {
            return landWid(
                ...
                landInfo[index][8],
                () => confirmDialog(
                        'Voulez-vous vraiment la mettre en vente?', context,
                        () async {
                      SmartDialog.showLoading();
                      if (connectedWithMetamask)
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  decoration: const InputDecoration(
                    ...
                    labelText: 'Area(SqFt)',
                    hintText: 'Entrer la superficie en SqFt',
                  ),
                ),
              ),
              Padding(
                ...
                child: CompositedTransformTarget(
                  ...
                  child: TextFormField(
                    validator: (value) {
                      if (value == null || value.isEmpty) {
                        return 'Entrer Addresse proprieté';
                      }
                      return null;
                    },
                    style: const TextStyle(
                    ...
                    decoration: const InputDecoration(
                      ...
                      border: OutlineInputBorder(),
                      labelText: 'Address',
                      hintText: 'Entrer Addresse proprieté',
                    ),
                  ),
                ),
              ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          CustomTextFiled(userInfo[1].toString(), 'Nom'),
