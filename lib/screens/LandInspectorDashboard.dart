...
class _LandInspectorState extends State<LandInspector> {
  ...
  List<Menu> menuItems = [
    ...
    Menu(title: 'Verifier un utilisateur', icon: Icons.verified_user),
    Menu(title: 'Verifier la propriété', icon: Icons.web),
    Menu(title: 'Transfert de Propriété', icon: Icons.transform),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      key: _scaffoldKey,
      appBar: AppBar(
        title: const Text("Tableau de bord Agent cadatres"),
        centerTitle: true,
            ...
            children: [
              ...
              Row(
                children: const [
                  ...
                  Expanded(
                      child: Center(
                        child: Text('Address proprietaire',
                            style: TextStyle(fontWeight: FontWeight.bold)),
                      ),
                      flex: 5),
                  Expanded(
              ...
              children: [
                ...
                Row(
                  children: const [
                    ...
                    Expanded(
                      child: Center(
                        child: Text('Transfert de Propriété',
                            style: TextStyle(fontWeight: FontWeight.bold)),
                      ),
                      flex: 3,
                    )
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                if (index == 1)
                  const Text('Total Propriété EnRegistrées',
                      style: TextStyle(fontSize: 20)),
                if (index == 2)
                  const Text('Total Propriété Transferé',
                      style: TextStyle(fontSize: 20)),
              ],
            ),
          ),
