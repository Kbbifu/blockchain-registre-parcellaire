...
const String contractAddress = "0xBC11d8d714203f441E07038A309E585bE7C2E194";

const int chainId = 1335; //Ropsten-3, Polygon testnet-80001, local ganache-1337
    ...
    showCupertinoDialog(
        ...
        builder: (BuildContext ctx) {
          return CupertinoAlertDialog(
            title: const Text('Confirmez Svp'),
            content: Text(msg),
            actions: [
              // The "Yes" button
